...
<div class="debajo">
    <div class="pie" id="pie1">
        <p>
            En tu casa o en la nuestra no importa donde estés, siempre vamos a engreirte con el gran sabor que nos caracteriza. ¡Gracias por preferirnos!
        </p>
        <img id="" src="../imagenes/logo pequeño.png" alt="">
    </div>
    ...
    <div class="pie" id="pie3">
        <h3>LEGAL</h3>
        <ul class="lista">
            <li><a href="../vistas/terminosycondiciones.php">Terminos y condiciones</a></li>
            <li><a href="../vistas/politicas.php">Políticas de privacidad</a></li>
        </ul>
    </div>
    <div class="pie" id="pie4">
        <H3>FORMAS DE PAGO</H3>
        <img src="https://d3uqmu8cgrse7a.cloudfront.net/dist/client/img/e001781.svg" alt="" width="64px" height="65px">
...
<div class="copy">
<p>@Chalet Belga 2021 - todos los derechos reservados</p>
</div>
